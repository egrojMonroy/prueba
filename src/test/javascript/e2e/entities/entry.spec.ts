...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/pruebaApp.entry.home.title/);
    ...
    it('should load create Entry dialog', () => {
        ...
        expect(entryDialogPage.getModalTitle()).toMatch(/pruebaApp.entry.home.createOrEditLabel/);
